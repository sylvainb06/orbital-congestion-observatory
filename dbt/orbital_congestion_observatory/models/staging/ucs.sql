SELECT
  ...
  -- IDENTIFIERS
  name_of_satellite_alternate_names AS satellite_alt_name,
  current_official_name_of_satellite AS satellite_name,
  SAFE_CAST(norad_number AS INT64) AS norad_cat_id,
